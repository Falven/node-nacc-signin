...
var NACC = {
    ...
    dashboard: {
        init: function(element) {
            if (window.jQuery) {
                new EditableTableController("#tutors-table", "/admin/dashboard/tutors", "Tutors sucessfully updated!", "Failed to update Tutors.");
                new EditableTableController("#mentors-table", "/admin/dashboard/mentors", "Mentors sucessfully updated!", "Failed to update Mentors.");
            }
        }
    },
    mailto: {
